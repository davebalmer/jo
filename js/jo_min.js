...
if(joGesture)
joGesture.load();if(typeof document.body.style.webkitTransition!=="undefined"){}
else if(typeof document.body.style.MozTransition!=="undefined"){joScroller.prototype.transitionEnd="transitionend";joScroller.prototype.setTop=function(y){var node=this.container.firstChild;node.style.MozTransform=y?("translateY("+y+"px)"):"";node.jotop=y;};this.platform="mozilla";}
else if(typeof document.body.style.OTransition!=="undefined"){joScroller.prototype.transitionEnd="otransitionend";joScroller.prototype.setTop=function(y){var node=this.container.firstChild;node.style.OTransform=y?("translateY("+y+"px)"):"";node.jotop=y;};this.platform="opera";}
else{joScroller.prototype.velocity=0;joScroller.prototype.bump=0;joScroller.prototype.transitionEnd="transitionend";joScroller.prototype.setTop=function(y){var node=this.container.firstChild;node.style.top=y?(y+"px"):"0";node.jotop=y;};}
...
this.titlebar.setData(this.firstTitle);},setTitle:function(title){this.titlebar.setData(title);this.firstTitle=title;}});joBackButton=function(){joButton.apply(this,arguments);};joBackButton.extend(joButton,{tagName:"jobackbutton"});joSelect=function(data,value){var ui=[this.field=new joSelectTitle(data[value||0]||"Select"),this.list=new joSelectList(data,value)];this.changeEvent=this.list.changeEvent;this.selectEvent=this.list.selectEvent;joExpando.call(this,ui);this.container.setAttribute("tabindex",1);this.list.selectEvent.subscribe(this.setValue,this);};joSelect.extend(joExpando,{setValue:function(value,list){this.field.setData(list.getNodeData(value));this.close();},getValue:function(){return this.list.getValue();},setEvents:function(){joControl.prototype.setEvents.call(this);},onBlur:function(e){joEvent.stop(e);joDOM.removeCSSClass(this,"focus");this.close();}});joSelectTitle=function(){joExpandoTitle.apply(this,arguments);};joSelectTitle.extend(joExpandoTitle,{});