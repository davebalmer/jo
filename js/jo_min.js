...
this.popEvent.fire();},home:function(){if(this.data&&this.data.length){var o=this.data[0];var c=this.data[this.index];if(o===c)
...
this.switchScroller();joStack.prototype.forward.call(this);},home:function(){this.switchScroller();joStack.prototype.home.call(this);},push:function(o){if(this.data&&this.data.length&&this.data[this.data.length-1]===o)
